...
export default {
    ...
    execute: withErrorHandling(async (interaction, config, client) => {
        ...
        // spinFrames = 100: đủ frame để tốc độ mỗi frame ≤ ~2.2 symbol
        // (trước đây 55 frame khiến reel 2 với extraSpins=3 phải nhảy ~4-5 symbol/frame → bị giật/không đều)
        const spinFrames = 100;              // 100 frame quay (~4.5 giây)
        ...
        // Giảm từ [2,3,3,4] xuống [1,1,1,2] để reel 2 không phải quay quá nhanh → không bị giật
