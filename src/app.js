...
import { checkCommunityMinesweeperGames } from './services/communityMinesweeperService.js';
...
class TitanBot extends Client {
  ...
  setupCronJobs() {
    ...
    cron.schedule('* * * * *', runSafeTask('community_minesweeper_check', () => checkCommunityMinesweeperGames(this)));
